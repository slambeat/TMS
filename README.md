Добавить 2 диска к виртуальной машине по10gb  каждый и создать по 2 раздела в каждом диске например /dev/sdb1, /dev/sdb2 /dev/sdc1,/dev/sdc2. По 5 gb каждый раздел
